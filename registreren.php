    ...
    <form class="col-form-label-lg" action="php/db_registratie.php" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="password" class="form-control" name="wachtwoord" id="wachtwoord" placeholder="Wachtwoord" required pattern=".{8,500}" title="Wachtwoord moet tussen de 8 en 25 karakters bevatten">
            </div>
            <div class="form-group col-md-6">
