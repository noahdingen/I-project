    ...
    <div class="container">
        ...
        <form class="col-form-label-lg" action="php/veiling_toevoegen_in_database.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="titel" id="titel" placeholder="Titel" pattern=".{0,60}" title="De titel mag niet meer dan 60 tekens zijn." required autofocus>
            </div>
            <div class="form-group">
                <label for="beschrijving">Beschrijving</label>
                <input type="text" class="form-control" name="beschrijving" id="beschrijving" placeholder="Beschrijving" pattern=".{0,255}" title="De beschrijving mag niet meer dan 255 tekens zijn." required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="betalingsinstructies" id="betalingsinstructies" placeholder="Betalingsinstructies" pattern=".{0,255}" title="De betalingsinstructies mag niet meer dan 255 tekens zijn.">
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="plaatsnaam" id="plaatsnaam" placeholder="Plaatsnaam" pattern=".{0,28}" title="De plaatsnaam mag niet meer dan 28 tekens zijn." required>
                </div>
            </div>

            <div class="form-group">
                <label for="verzendinstructies">Verzendinstructies</label>
                <input type="text" class="form-control" name="verzendinstructies" id="verzendinstructies" placeholder="verzendinstructies" pattern=".{0,255}" title="De verzendinstructies mag niet meer dan 255 tekens zijn.">
            </div>
